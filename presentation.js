...
(function () {
  ...
  var STORIES = [
    { route: 'lists', pre: function () { WL.store.listView = 'items'; }, nav: 'Списки и приоритеты',
      eyebrow: 'История 1 из 6 · Владелец',
      title: 'Я веду списки по поводам и помечаю, что хочу сильнее всего',
    ...
    { route: 'lists', pre: function () { WL.store.listView = 'activity'; }, nav: 'Активность списка',
      eyebrow: 'История 6 из 6 · Владелец',
      title: 'Я вижу, что список работает — но не вижу, кто что сделал',
