  ...
  function register(app) {
    ...
    app.component('IdeasScreen', {
      ...
      template: [
        ...
        '    <button class="field__go" @click="A.toast(\'Поиск по каталогу — в прототипе\')" aria-label="Искать" title="Искать">',
        '      <ui-icon name="search" :size="19" />',
        '    </button>',
        '    <button class="field__cog" :class="{\'is-on\':A.filterCount()}" @click="A.openSheet(\'filters\')" title="Фильтры" aria-label="Фильтры">',
        '      <ui-icon name="settings" :size="19" />',
